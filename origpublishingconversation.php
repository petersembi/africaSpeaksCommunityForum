...
<head>
    ...
    <link href="/assets/css/internal_style.css?ver=221221041632" rel="stylesheet"/>
...
<link rel="stylesheet" media="screen" href="https://community.africaspeaks.global/assets/css/main.css?v=221221041632">
...
<script>
    ...
    $(document).ready(function () {
        ...
        const commentControl = {
            ...
            setEndPoint($endpoint){
                ...
                this.element.find('a.ajaxBtns').attr('data-redirect-url', 'https://community.africaspeaks.global/forum/home/the-place-of-writing-in-the-history-of-christianity-in-africa');
            },
    ...
    handle(xhr, status, error){
        ...
        div.wpb_column.pos-top.pos-center.align_left.column_parent.col-lg-7.single-internal-gutter{
...
<div class="container-fluid " id="frameWrapper">
        ...
        <div class="col-12 pt-5">
            <a id="backHome" class="btn btn-warning" href="/forum/home/"><i class="bi bi-arrow-return-left"></i> BACK HOME</a>
        </div>
    </div>
    ...
    <div id="" class="row containMaxWidth">
            ...
            <div class="col-12 col-md-9">
                <div id="communityContent"><div data-parent="true" class="vc_row inverted-device-order limit-width row-container" id="row-unique-0"><div class="row col-double-gutter quad-top-padding quad-bottom-padding single-h-padding row-parent" style="max-width:1596px; margin-left:auto; margin-right:auto;"><div class="wpb_row row-inner"><div class="wpb_column pos-top pos-center align_left column_parent col-lg-7 single-internal-gutter"><div class="uncol style-light"  ><div class="uncoltable"><div class="uncell no-block-padding" ><div class="uncont"><div class="uncode-single-media  text-left"><div class="single-wrapper" style="max-width: 100%;"><div class="tmb tmb-light  tmb-img-ratio tmb-media-first tmb-media-last tmb-content-overlay tmb-no-bg"><div class="t-inside"><div class="t-entry-visual"><div class="t-entry-visual-tc"><div class="uncode-single-media-wrapper"><div class="h3 fluid-object" style="padding-top: 42.54%"><iframe width="1904" height="810" src="https://www.youtube.com/embed/j-p-_I1ukv8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
					</div>
				</div></div></div></div></div></div></div></div></div></div><script id="script-row-unique-0" data-row="script-row-unique-0" type="text/javascript" class="vc_controls">UNCODE.initRow(document.getElementById("row-unique-0"));</script></div></div></div><div data-parent="true" class="vc_row inverted-device-order row-container" id="row-unique-1"><div class="row unequal col-double-gutter double-top-padding double-bottom-padding single-h-padding limit-width row-parent"><div class="wpb_row row-inner"><div class="wpb_column pos-middle pos-center align_left column_parent col-lg-4 single-internal-gutter"><div class="uncol style-light"  ><div class="uncoltable"><div class="uncell no-block-padding" ><div class="uncont"><div class="vc_custom_heading_wrap ">
                    <div class="heading-text el-text" ><h1 class="font-361897 h1 text-color-133991-color" ><span>Publishing Conversations | S01EP01 | The Place of Writing in The History of Christianity In Africa</span></h1></div><div class="clear"></div></div><div class="uncode_text_column" ><p><span class="font-204842">In this conversation, Dr. Kyama Mugambi of Africa Theological Network Press on the issues around Africa and Christian publishing.</span></p>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 topicAttributes d-flex justify-content-end lightGreyColor">
                        <div class="d-flex">
                            <div class="mr-3">
                                <div class="topicLikeWrapper">
                                    <div data-id="2" class="darkBrownBg contentLike topicLike topicLikeHover">
                                        <div> <img class="img-fluid" src="https://community.africaspeaks.global/assets/images/like.png"/></div>
                            ...
                            <div class="mr-3 text-center">
                                <img data-toggle="tooltip" data-placement="top" title="Comments" src="https://community.africaspeaks.global/assets/images/messaging_96px.png"/>
                                <div>Comments: 1</div>
                            </div>
                            <div class="text-center">
                                <img data-toggle="tooltip" data-placement="top" title="Views" src="https://community.africaspeaks.global/assets/images/reading_96px.png"/>
                                <div>Views: 10</div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="commentsWrapper">
                            ...
                            <div class="commentControlWrapper">

                            </div>
                                                                <div id="comment23" class="comment my-3 p-3">
                                        <div class="row">
                                            <div class="col commentLikeWrapper">
                                            ...
                                            <div class="col">
                                                <div class="row py-2">
                                                    <div class="col"><a class="font-weight-bold userName">Alexander Kimaru (akimaru)</a></div>
                                                    <div class="col text-right">#1</div>
                                                </div>
                                                <p class="small lightGreyColor">6 months ago (May 25,2022 01:37:54 am)</p>
                                                                                                <p>Interesting Video</p>
                                                <div class="d-flex">

                                                    <div data-comment-id="23" class="darkBrownBg commentLike commentLikeHover">
                                                        <div> <img class="img-fluid" src="https://community.africaspeaks.global/assets/images/like_grey.png"/></div>
                                                        <div class="likeCount">0</div>
                                                    </div>
                                                    <div class="commentActions">

                                                            <a data-comment-id="23" class="mx-2 btn replyBtn">Reply</a>
                                                                                                                            <a data-comment-id="23"  class="mx-2 editBtn btn">Edit</a>
                                                                <a data-comment-id="23"  class="mx-2 deleteBtn btn">Delete</a>
                                                            
                                                    </div>
                                                    <div class="col d-flex justify-content-end">
                                                        <div class="commentActions">
                                                            <a data-endpoint="/api/forum_report_content_comment" data-comment-id="23"  class="mx-1 btn reportBtn">Report</a>
                                                        </div>
                                                    </div>
            ...
            <div class="col-12 col-md-3">
                                    <h4 class="greyColor pt-5">Trending</h4>
                                            <h5 class="redColor py-3"><a class="redColor" href="/forum/home/improving-quality-and-encouraging-publishing">Publishing Conversations | S01EP03 | Improving Quality &#038; Encouraging Publishing</a> </h5>
                                            <h5 class="redColor py-3"><a class="redColor" href="/forum/home/the-future-of-africas-christianity-and-publishing">Publishing Conversations | S01EP05 | The Future of Africa&#8217;s Christianity and Publishing</a> </h5>
                                            <h5 class="redColor py-3"><a class="redColor" href="/forum/home/the-place-of-writing-in-the-history-of-christianity-in-africa">Publishing Conversations | S01EP01 | The Place of Writing in The History of Christianity In Africa</a> </h5>
                                            <h5 class="redColor py-3"><a class="redColor" href="/forum/home/myths-about-christian-publishing-in-africa">Publishing Conversations | S01EP02 | Myths About Christian Publishing In Africa</a> </h5>
                                                </div>
    ...
    <div class="commentControl collapse">
        <form>
            ...
            <input type="hidden" name="csrf_africa_speaks" value="27deb3947031159af804e24ffa800063" />            <input type="hidden" name="content_id" id="content_id" value="2">
...
<div class="modal fade" id="reportModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <form>
            <input type="hidden" name="csrf_africa_speaks" value="27deb3947031159af804e24ffa800063" />            <input type="hidden" name="user_id">
